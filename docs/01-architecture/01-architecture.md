...
**Stack**: Go + MySQL + Redis + MongoDB · **Audience**: All engineering roles
...
| **Rules Engine** | **`antonmedv/expr` · YAML rules in ConfigMap · hot-reload via fsnotify** |
...
| **CDC** | **Debezium MySQL connector → Kafka → Elasticsearch sink**  |
